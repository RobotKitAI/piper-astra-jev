...
The recordings are not included in the repository; the script is here so the
figures can be redrawn from a recording of your own (see piper_llm/record.py).
